...
<?php echo $this->Form->input('date1', array('type' => 'text', 'id' => 'datepicker1', 'label' => 'シッティング・散歩代行希望日')) . PHP_EOL; ?>
<?php echo $this->Form->input('date2', array('type' => 'text', 'id' => 'datepicker2', 'label' => 'ご希望打ち合わせ日')) . PHP_EOL; ?>
