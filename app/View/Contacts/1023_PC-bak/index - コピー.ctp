...
<?php echo $this->Form->input('date1', array('type' => 'text', 'id' => 'datepicker1', 'label' => 'シッティング・散歩代行希望日1')) . PHP_EOL; ?>
<?php echo $this->Form->input('date2', array('type' => 'text', 'id' => 'datepicker2', 'label' => 'シッティング・散歩代行希望日2（連日の場合の記入例：10/21まで…等）')) . PHP_EOL; ?>
