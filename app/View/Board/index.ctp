...
<?php echo $this->Form->create('Board'); ?>
	...
	<?php echo $this->Form->input('subject', array('label' => 'タイトル') ); ?><br />
	<?php echo $this->Form->input('content', array('type' =>'textarea' ,'label' => '本文') ); ?> 
...
<?php echo $this->Form->input('delno', array('label' => '削除記事No.', 'width' =>5) ); ?>
<?php echo $this->Form->submit(); ?>
<?php echo $this->Form->end(); ?>
</div>
